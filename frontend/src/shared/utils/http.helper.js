...
/**
 * Purpose: A centralized axios instance used by the frontend to communicate
 * with the backend API. This file encapsulates the following cross-cutting
 * concerns so callers can use a consistent interface (`http` / `httpHelper`):
 */
